...
class AnimatedTransition {
    ...
    AnimatedTransition(Projection projection, ClusterPoint originClusterPoint, InputPoint firstRelevantInputPointFromOriginClusterPoint, ClusterPoint destinationClusterPoint) {
        ...
        this.originClusterRelevantInputPoints = new ClusterPoint(firstRelevantInputPointFromOriginClusterPoint, projection, true, originClusterPoint.getMapPosition());
