...
public final class QuestionSingleChooseBL extends QuestionBaseChooseBL {
    ...
    public void initView(View view, Question question, Bundle savedInstanceState) {
        super.initView(view, question, savedInstanceState, R.string.choose_one_answer, itemClickListener,
                new AnswerRadioButtonAdapter(view.getContext(), answerSelectedListener));
    }
