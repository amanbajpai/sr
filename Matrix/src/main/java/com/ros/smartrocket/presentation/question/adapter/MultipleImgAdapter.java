...
public class MultipleImgAdapter extends RecyclerView.Adapter<MultipleImgAdapter.ViewHolder> {

    List<Answer> galleryinfoList;
    Context mContext;
    OnClickImage onClickImage;

    public MultipleImgAdapter(List<Answer> values, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Answer bean = galleryinfoList.get(position);

        Glide.with(mContext).load(bean.getFileUri()).into(holder.iv_horizontal_img);
    }
    ...
    public interface OnClickImage {
        void onItemClick(Answer galleryInfo, int pos);
    }
